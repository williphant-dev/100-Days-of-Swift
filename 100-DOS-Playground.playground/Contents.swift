...
//OR operator - either the first condition or second must be true
...
case .snow:
    print("School might be cancelled")
case .unknown:
    print("The generator is broken!")
}

// ternary conditional operator - need more readup - not exactly sure on this one
...
let crewCount = name.isEmpty ? "No one" : "\(names3.count) people"
